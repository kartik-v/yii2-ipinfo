 ...
 */!function(t){"use strict";var e=function(e,n){var a=this;a.$element=t(e),a.init(n)};e.prototype={constructor:e,init:function(e){var n=this,a=n.$element;t.each(e,function(t,e){n[t]=e}),t.ajax({url:n.url,type:"GET",dataType:"json",data:n.params,beforeSend:function(t){a.trigger("beforesend.kvipinfo",[t])},success:function(e,r,o){var i,f,p,s,l,c=e,d="",u=c.country_code;a.trigger("success.kvipinfo",[e,r,o]),c&&u?(n.flagWrapper&&(s=t.isEmptyObject(n.flagOptions)?{}:n.flagOptions,l="flag-icon-"+u.toLowerCase(),p=t(document.createElement("div")).attr(s).removeClass(l).addClass(l),t("#"+n.flagWrapper).html("").append(p)),t.each(n.fields,function(t,e){void 0!==c[e]&&(d+="<tr><th>"+n.defaultFields[e]+"</th><td>"+c[e]+"</td></tr>\n")}),d?(i=t(document.createElement("table")).attr(n.contentOptions).append(d),f=t(document.createElement("div")).append(i),a.html(f.html()),f.remove()):a.html(n.noData)):a.html(n.noData)},error:function(t,e,r){a.trigger("error.kvipinfo",[t,e,r]).html(n.errorData)}})}},t.fn.kvIpInfo=function(n){var a=Array.apply(null,arguments);return a.shift(),this.each(function(){var r,o=t(this),i=o.data("kvIpInfo"),f="object"==typeof n&&n;i||(r=t.extend({},t.fn.kvIpInfo.defaults),i=new e(this,t.extend(r,f,o.data())),o.data("kvIpInfo",i)),"string"==typeof n&&i[n].apply(i,a)})},t.fn.kvIpInfo.defaults={flagWrapper:"",flagOptions:{},fields:[],defaultFields:{},url:"",params:{},contentOptions:{},noData:"",errorData:""},t.fn.kvIpInfo.Constructor=e}(window.jQuery);